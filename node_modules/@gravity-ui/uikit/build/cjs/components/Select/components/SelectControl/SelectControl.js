...
exports.SelectControl = react_1.default.forwardRef((props, ref) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: (0, constants_1.selectControlBlock)(controlMods), role: "group" },
            react_1.default.createElement("button", { id: selectId, ref: ref, role: "combobox", "aria-controls": popupId, className: (0, constants_1.selectControlButtonBlock)(buttonMods, className), "aria-haspopup": "listbox", "aria-expanded": open, "aria-activedescendant": activeIndex === undefined ? undefined : `${popupId}-item-${activeIndex}`, disabled: disabled, onClick: handleControlClick, onKeyDown: onKeyDown, type: "button", "data-qa": qa, title: title },
