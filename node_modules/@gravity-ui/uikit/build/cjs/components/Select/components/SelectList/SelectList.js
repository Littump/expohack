...
exports.SelectList = react_1.default.forwardRef((props, ref) => {
    ...
    return (react_1.default.createElement(List_1.List, { ref: ref, className: (0, constants_1.selectListBlock)({ size, virtualized, mobile }), qa: constants_1.SelectQa.LIST, itemClassName: (0, constants_1.selectListBlock)('item'), itemHeight: getItemHeight, itemsHeight: virtualized ? optionsHeight : undefined, items: items, filterable: false, virtualized: virtualized, renderItem: renderItem, onItemClick: onOptionClick, selectedItemIndex: selectedIndexes, id: id, role: "listbox", onChangeActive: onChangeActive }));
});
