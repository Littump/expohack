...
exports.Select = react_1.default.forwardRef(function Select(props, ref) {
    ...
    const { value, open, activeIndex, toggleOpen, setValue, handleSelection, handleClearValue, setActiveIndex, } = (0, hooks_1.useSelect)({
        onUpdate,
        value: propsValue,
        defaultValue,
        defaultOpen,
    ...
    const _renderFilter = () => {
        if (filterable) {
            return (react_1.default.createElement(components_1.SelectFilter, { ref: filterRef, size: size, value: filter, placeholder: filterPlaceholder, onChange: setFilter, onKeyDown: handleFilterKeyDown, renderFilter: renderFilter }));
        }
        return null;
    };
