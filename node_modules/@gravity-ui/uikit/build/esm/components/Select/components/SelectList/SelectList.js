...
export const SelectList = React.forwardRef((props, ref) => {
    const { onOptionClick, renderOption, renderOptionGroup, getOptionHeight, getOptionGroupHeight, size, flattenOptions, value, multiple, virtualized, mobile, loading, onLoadMore, id, onChangeActive, } = props;
    ...
    return (React.createElement(List, { ref: ref, className: selectListBlock({ size, virtualized, mobile }), qa: SelectQa.LIST, itemClassName: selectListBlock('item'), itemHeight: getItemHeight, itemsHeight: virtualized ? optionsHeight : undefined, items: items, filterable: false, virtualized: virtualized, renderItem: renderItem, onItemClick: onOptionClick, selectedItemIndex: selectedIndexes, id: id, role: "listbox", onChangeActive: onChangeActive }));
});
