...
export const SelectControl = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: selectControlBlock(controlMods), role: "group" },
            React.createElement("button", { id: selectId, ref: ref, role: "combobox", "aria-controls": popupId, className: selectControlButtonBlock(buttonMods, className), "aria-haspopup": "listbox", "aria-expanded": open, "aria-activedescendant": activeIndex === undefined ? undefined : `${popupId}-item-${activeIndex}`, disabled: disabled, onClick: handleControlClick, onKeyDown: onKeyDown, type: "button", "data-qa": qa, title: title },
