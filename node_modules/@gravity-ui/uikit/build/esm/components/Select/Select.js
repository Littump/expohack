...
import { EmptyOptions, HiddenSelect, SelectControl, SelectFilter, SelectList, SelectPopup, } from './components';
...
export const Select = React.forwardRef(function Select(props, ref) {
    ...
    const { value, open, activeIndex, toggleOpen, setValue, handleSelection, handleClearValue, setActiveIndex, } = useSelect({
        onUpdate,
        value: propsValue,
        defaultValue,
        defaultOpen,
    ...
    const _renderFilter = () => {
        if (filterable) {
            return (React.createElement(SelectFilter, { ref: filterRef, size: size, value: filter, placeholder: filterPlaceholder, onChange: setFilter, onKeyDown: handleFilterKeyDown, renderFilter: renderFilter }));
        }
        return null;
    };
    ...
    return (React.createElement("div", Object.assign({ ref: controlWrapRef, className: selectBlock(mods, className) }, focusWithinProps, { style: inlineStyles }),
        ...
        React.createElement(SelectPopup, { ref: controlWrapRef, className: popupClassName, controlRef: controlRef, width: popupWidth, open: open, handleClose: handleClose, disablePortal: disablePortal, virtualized: virtualized, mobile: mobile, placement: popupPlacement, onAfterClose: filterable
                ? () => {
                    setFilter('');
                }
        ...
        React.createElement(HiddenSelect, { name: name, value: value, disabled: disabled, form: form, onReset: setValue })));
});
